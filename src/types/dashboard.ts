/**
 * Dashboard types for vendor/admin dashboard functionality.
 * Adapted from dashboard/src/types/index.ts
 */
...
// ─── Dashboard User (unified vendor/admin type) ──────────────────────────────

export type DashboardUserRole = 'vendor' | 'admin';
...
export interface DashboardUser {
  ...
  user_id: string;
  email: string;
  // Vendor fields (null if admin)
  vendor: Vendor | null;
  // Admin fields (null if vendor)
