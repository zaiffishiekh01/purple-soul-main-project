...
DROP POLICY IF EXISTS "Vendors can view own payout requests" ON payout_requests;
DROP POLICY IF EXISTS "Vendors can create payout requests" ON payout_requests;
DROP POLICY IF EXISTS "Admins can select all payout requests" ON payout_requests;
...
DROP POLICY IF EXISTS "Vendors can view own platform fees" ON platform_fees;
DROP POLICY IF EXISTS "Admins can manage all platform fees" ON platform_fees;
