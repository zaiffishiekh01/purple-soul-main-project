...
DROP POLICY IF EXISTS "Admins can manage warehouse plans" ON warehouse_storage_plans;
DROP POLICY IF EXISTS "Anyone can view active warehouse plans" ON warehouse_storage_plans;
...
DROP POLICY IF EXISTS "Admins can select all warehouse requests" ON warehouse_requests;
DROP POLICY IF EXISTS "Admins can update warehouse requests" ON warehouse_requests;
DROP POLICY IF EXISTS "Admins can insert warehouse requests" ON warehouse_requests;
...
DROP POLICY IF EXISTS "Vendors can view own inbound shipments" ON warehouse_inbound_shipments;
DROP POLICY IF EXISTS "Admins can manage all inbound shipments" ON warehouse_inbound_shipments;
...
DROP POLICY IF EXISTS "Admins can manage all warehouse inventory" ON warehouse_inventory;
