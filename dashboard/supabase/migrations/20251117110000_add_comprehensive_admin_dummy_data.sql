...
(
  ...
  (SELECT id FROM admin_users WHERE email = 'admin@sufiscience.com' LIMIT 1)
),
(
...
(
  ...
  (SELECT id FROM admin_users WHERE email = 'sales@sufiscience.com' LIMIT 1)
),
(
...
(
  ...
  (SELECT id FROM admin_users WHERE email = 'finance@sufiscience.com' LIMIT 1),
  NOW() - INTERVAL '3 hours',
  NOW() - INTERVAL '1 day',
  NOW() - INTERVAL '3 hours'
),
